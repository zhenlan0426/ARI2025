...
class Gemma3MultiModalProjector(nn.Module):
    ...
    def forward(self, vision_outputs: torch.Tensor):
        # batch_size, _, seq_length = vision_outputs.shape # (batch, seq_len, hidden_size)
        ...
        normed_vision_outputs = self.mm_soft_emb_norm(vision_outputs)
        ...
        **lm_kwargs,
        ...
        if pixel_values is not None:
            ...
            if input_ids is None:
                ...
                special_image_mask = (input_ids == self.config.image_token_index).unsqueeze(-1) # 1, L, 1
                special_image_mask = special_image_mask.expand_as(inputs_embeds).to(inputs_embeds.device) # 1, L, h
